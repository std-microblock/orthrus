...
namespace HitmanPatcher
{
	public static class v3_30
	{
		...
		private static HitmanVersion v3_30_0_dx12 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x0F96A9D, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x3AC8998, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[]
			{
				new Patch(0x1E55A40, "68", "61", MemProtection.PAGE_READONLY) // dont ask me why this works
			},
			dynres_noforceoffline = new[] { new Patch(0x3AC9318, "01", "00", MemProtection.PAGE_EXECUTE_READWRITE) }
		};
	}
}
