...
namespace HitmanPatcher
{
	public static class v3_120
	{
		...
		private static HitmanVersion v3_120_0_epic_dx12 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x0FCF7CD, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x3C855B8, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[] {
			...
			dynres_noforceoffline = new[] { new Patch(0x3C85810, "01", "00", MemProtection.PAGE_EXECUTE_READWRITE) }
		};

		private static HitmanVersion v3_120_0_steam_dx12 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x0FCF06D, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x3C8CB78, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[] { new Patch(0x1ED0E28, "68", "61", MemProtection.PAGE_READONLY) },
			dynres_noforceoffline = new[] { new Patch(0x3C8CDD0, "01", "00", MemProtection.PAGE_EXECUTE_READWRITE) }
		};

		private static HitmanVersion v3_120_0_gamepass_dx12 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x10159ED, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x3D594C8, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[] {
			...
			dynres_noforceoffline = new[] { new Patch(0x3D58DC8, "01", "00", MemProtection.PAGE_EXECUTE_READWRITE) }
		};
	}
}
