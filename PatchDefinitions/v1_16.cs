...
namespace HitmanPatcher
{
	public static class v1_16
	{
		...
		private static HitmanVersion v1_16_0_epic_dx11 = new HitmanVersion()
		{
		...
		private static HitmanVersion v1_16_0_gog_dx11 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x0CD649C, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x2739988, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[]
			{
				new Patch(0x14DA438, "68", "61", MemProtection.PAGE_READONLY)
			},
			dynres_noforceoffline = new[] { new Patch(0x2739e08, "01", "00", MemProtection.PAGE_READWRITE) }
		};

		private static HitmanVersion v1_16_0_gog_dx12 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x0CD754C, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x2742D88, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[]
			{
				new Patch(0x14E2488, "68", "61", MemProtection.PAGE_READONLY) // this is just stupid
			},
			dynres_noforceoffline = new[] { new Patch(0x2743208, "01", "00", MemProtection.PAGE_READWRITE) }
		};
	}
}
