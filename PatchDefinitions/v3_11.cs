...
namespace HitmanPatcher
{
	public static class v3_11
	{
		...
		private static HitmanVersion v3_11_0_dx12 = new HitmanVersion()
		{
			certpin = new[] { new Patch(0x0CA5F3E, "0F85", "90E9", MemProtection.PAGE_EXECUTE_READ) },
			authheader = new[]
			{
			...
			configdomain = new[] { new Patch(0x2AB84E8, "", "", MemProtection.PAGE_READWRITE, "configdomain") },
			protocol = new[]
			{
			...
			dynres_noforceoffline = new[] { new Patch(0x2AB8E68, "01", "00", MemProtection.PAGE_EXECUTE_READWRITE) }
		};
	}
}
